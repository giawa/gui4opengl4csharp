...
namespace Example9
{
    public static class Window
    {
        ...
        private static void LockMouse(OpenGL.UI.Click Mouse)
        {
            if (Mouse.state == OpenGL.UI.MouseState.Up) WarpPointer(downx, downy);

            SDL.SDL_ShowCursor((Mouse.state == OpenGL.UI.MouseState.Down) ? 0 : 1);
        ...
        public static void MouseRightClick(OpenGL.UI.Click Mouse)
        {
            LockMouse(Mouse);
        ...
        public static void MouseLeftClick(OpenGL.UI.Click Mouse)
        {
